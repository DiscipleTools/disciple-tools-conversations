...
class Disciple_Tools_Conversations_Site_Links {
    public $type = 'disciple_tools_conversations';
    ...
    public function site_link_type( $type ) {
        $type[$this->type] = __( 'Disciple.Tools Conversations' );
        return $type;
    }
}
Disciple_Tools_Conversations_Site_Links::instance();
